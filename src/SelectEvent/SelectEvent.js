        ...
        <div className='container'>
          <div className='row'>
            <div className='col-sm-6 center left'>
             {/*  <p className="text-white">Note <span className=""> *</span> Events going on <span className="text-dark" ><b>DATE</b></span>, click on event to add to your own day of events</p> */}
              <h4 className="mb-4 text-white"> Click on event to add to your own day of events</h4>
                      ...
                      modelInstance.morningEventList.map(event =>
                        <div key={event.id} className="card-block">
                          ...
                          <div className='col-sm-3 m-auto'>
                                <div className="font1">
                                  <i className="fa fa-clock-o"></i> {event.dates.start.localTime} </div>
                          </div>
                        ...
                        <div key={event.id} className="card-block ">
                          <div className="container-fluid py-2">
                            <div className="row">
                              <div className='col-sm-3 m-auto' >
                                <div className="font1">
                                  <i className="fa fa-clock-o"></i> {event.dates.start.localTime}
                                </div>
                              </div>
                              <div className='col-sm-7'>
                                <b>{event.name}</b>
